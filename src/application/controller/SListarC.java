...
import application.persistence.SSelectAll;
...
public class SListarC implements IListarC {
    ...
    public SListarC(TextField fieldId, TextField fieldItem, TextField fieldMarca, TextField fieldModelo, TextField fieldCor, TextField fieldPreco, TextArea textAreaList) {
    ...
    public List<Produto> listar() {
        ...
        SSelectAll dao = new SSelectAll(sf);

        SLimparC l = new SLimparC(fieldId, fieldItem, fieldMarca, fieldModelo, fieldCor, fieldPreco);
        l.limpar();
