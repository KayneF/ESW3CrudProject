...
public class SLimparProduto implements ILimpar {
    ...
    public SLimparProduto(TextField fieldId, TextField fieldItem, TextField fieldMarca, TextField fieldModelo, TextField fieldCor, TextField fieldPreco) {
